...
pub(crate) struct ExtGState {
    ref_: Ref,
    /// Whether this graphics state is used in the default appearance stream of form fields
    forms: bool,
}
...
pub(crate) struct ColorSpace {
    ref_: Ref,
    /// Whether this color space is used in the default appearance stream of form fields
    forms: bool,
}
