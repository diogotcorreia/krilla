...
fn main() {
    ...
    let combobox_appearance = {
        ...
        surface.draw_path(&rect_to_path(0.0, 0.0, 40.0, 20.0));
    ...
    let combobox_widget = combobox_field.new_widget(
        Rect::from_xywh(120.0, 120.0, 40.0, 20.0).unwrap(),
        combobox_appearance,
    );
    ...
    let listbox_appearance = {
        ...
        surface.draw_path(&rect_to_path(0.0, 0.0, 40.0, 40.0));
        surface.set_stroke(None);
    ...
    let listbox_widget = listbox_field.new_widget(
        Rect::from_xywh(120.0, 150.0, 40.0, 40.0).unwrap(),
        listbox_appearance,
    );
